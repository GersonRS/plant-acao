...
public class ComponenteModoDesafio extends Componente {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public ComponenteModoDesafio() {
		super();
		...
		imgComponente = new ImageIcon(getClass().getResource("imagens/metodoss.png"));
